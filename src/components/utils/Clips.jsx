...
const Clips = ({clip, imgsrc}) => {
  return (
    ...
    overflow-hidden group cursor-pointer lg:w-28 md:w-24 sm:w-16 lg:h-24 md:h-20 sm:h-14'>
      ...
      opacity-0 z-0 group-hover:opacity-100 
